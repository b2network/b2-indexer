...
func TestBitcoinConfig(t *testing.T) {
	...
	os.Unsetenv("BITCOIN_BRIDGE_AA_PUBKEY_API")
	...
	require.Equal(t, "127.0.0.1:8080/v1/btc/pubkey", config.Bridge.AAPubKeyAPI)
...
func TestBitcoinConfigEnv(t *testing.T) {
	...
	os.Setenv("BITCOIN_BRIDGE_AA_PUBKEY_API", "127.1.1.1:1234/v1/btc/xx")
	...
	require.Equal(t, "127.1.1.1:1234/v1/btc/xx", config.Bridge.AAPubKeyAPI)
